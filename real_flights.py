clfVUELOS = ['fail_indoors1','fail_indoors2','fail_indoors3','fail_indoors4','mov_indoors','fail_outdoors','mov_outdoors','vuelo de simulacion']#, 'movement1','movement2','fail1','fail2']
...
sub_version = 2
version = "1.{}".format(sub_version)
version2= "1_{}".format(sub_version) #solo para el archivo
...
for k,features in enumerate(FEATURES):
    ...
    clf = joblib.load('Clasificadores/RF({})_n{}_f{}_tr{}_{}'.format(CLASSIFIERS[k],n,Fs,sims,version))
...
# GRAFICOS:
        ...
        ax1 = plt.subplot(311)
        plt.title('{} ({}) V{}'.format(name,CLASSIFIERS[k],version), fontsize=30)
...
# Save Fig:   
        plt.savefig('Results/Vuelos/{}({}){}'.format(name,CLASSIFIERS[k],version2),bbox_inches='tight')#,format='eps')
